            ...
            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 mb-10">
                    <div className="col-span-full hidden lg:col-span-1 lg:block">
                        <a className="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80" href="#" aria-label="Brand">Techype</a>
                    ...
                    {footer.map((tags) => {
                        return (
                            ...
                            <div key={tags.tag}>
                                <h4 className="text-base font-semibold text-gray-900 uppercase">{tags.tag}</h4>
                                {tags.links.map((comTag) => {
                                    return (
                                        <div key={comTag} className="mt-3 grid space-y-3 text-sm">
                                            <li><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800" href="#">{comTag}</a></li>
                                        </div>
                                    )
                                })}
                            </div>
                ...
                <div className="pt-5 mt-5 border-t border-gray-200">
                    <div className="sm:flex sm:justify-between sm:items-center text-sm">
